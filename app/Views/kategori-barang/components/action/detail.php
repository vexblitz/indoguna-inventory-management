...
<head>
    ...
    <title>Detail Kategori Barang</title>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        <h2 class="h3">Detail Kategori Barang</h2>
                            ...
                            <form action="<?= base_url('kategori-barang')?>">

                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    <div class="col-12">
                                        <label for="nama_kategori" class="form-label">Nama Kategori <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" value="<?= esc($barang['nama_kategori']) ?>" disabled>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
