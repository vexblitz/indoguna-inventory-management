...
<head>
    ...
    <title>Update Kategori Barang</title>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        <h2 class="h3">Edit Kategori Barang</h2>
                                        <h3 class="fs-6 fw-normal text-secondary m-0">Isikan Dengan Jelas</h3>
                                    </div>
                                </div>
                            </div>
                            <form action="<?= base_url('kategori-barang/update')?>" method="post">
                                ...
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" value="<?= $barang['nama_kategori'] ?>" required>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
