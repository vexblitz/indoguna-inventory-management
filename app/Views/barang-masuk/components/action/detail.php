...
<body>
    <!-- Detail Transaksi Barang Masuk - Bootstrap Brain Component -->
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        <h2 class="h3">Detail Transaksi Barang Masuk</h2>
                            ...
                            <form action="<?= base_url('transaksi-barang-masuk') ?>">
                                <?= csrf_field() ?>

                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    <div class="col-12">
                                        <label for="kode_transaksi" class="form-label">Kode Transaksi <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="kode_transaksi" id="kode_transaksi" value="<?= esc($barangMasuk['kode_transaksi']) ?>" disabled>
                                    </div>
                                    <div class="col-12">
                                        <label for="kode_barang" class="form-label">Kode Barang <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="kode_barang" id="kode_barang" value="<?= esc($barangMasuk['kode_barang']) ?>" disabled>
                                    </div>
                                    <div class="col-12">
                                        <label for="nama_barang" class="form-label">Nama Barang <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="nama_barang" id="nama_barang" value="<?= esc($barangMasuk['nama_barang']) ?>" placeholder="Isikan Nama Barang Dengan Benar" disabled>
                                    </div>
                                    <div class="col-12">
                                        <label for="jumlah_masuk" class="form-label">Jumlah Masuk <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="jumlah_masuk" id="jumlah_masuk" value="<?= esc($barangMasuk['jumlah_masuk']) ?>" disabled>
                                    </div>
                                    <div class="col-12">
                                        <label for="stok_saat_ini" class="form-label">Stok Saat Ini <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="stok_saat_ini" id="stok_saat_ini" value="<?= esc($barangMasuk['stok_saat_ini']) ?>" disabled>
                                    </div>
                                    <div class="col-12">
                                        <label for="tanggal_masuk" class="form-label">Tanggal Masuk <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="tanggal_masuk" id="tanggal_masuk" value="<?= esc($barangMasuk['tanggal_masuk']) ?>" disabled>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '<?= base_url('transaksi-barang-masuk/create') ?>',
                dataType: 'json',
