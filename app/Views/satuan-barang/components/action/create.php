...
<head>
    ...
    <title>Indoguna - Satuan Barang</title>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        <h2 class="h3">Tambah Data Satuan</h2>
                            ...
                            <form action="<?= base_url('satuan-barang/store') ?>" method="post">
                                ...
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="nama_satuan" id="nama_satuan" placeholder="Isikan Nama Satuan Dengan Benar" required>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
