                    ...
                    <div class="col-12 col-md-6">
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-5">
                                        <h2 class="h3">Tambah Data Hak Akses</h2>
                            ...
                            <form action="/permissions-store" method="post">
                                ...
                                <div class="row gy-3 gy-md-4 overflow-hidden">
                                    <div class="col-12">
                                        <label for="permission_name" class="form-label">Hak Akses <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="permission_name" id="permission_name" value="<?= old('permission_name') ?>" placeholder="Isikan Hak Akses Dengan Benar" required>
                                    </div>
                                    <div class="col-12">
